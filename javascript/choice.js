                ...
                value: function(e, t) {
                    ...
                    if (null != r) {
                        ...
                        if ("string" == typeof r) {
                            this._log("\nKey: ".concat("" === i ? "-" : i));
                            var y = d.search(r);
                            if (this._log('Full text: "'.concat(r, '", score: ').concat(y.score)),
                            this.options.tokenize) {
                                for (var E = r.split(this.options.tokenSeparator), I = [], S = 0; S < h.length; S += 1) {
                                    ...
                                    for (var O = !1, C = 0; C < E.length; C += 1) {
                                        var A = E[C]
                                          , L = w.search(A)
                                          , T = {};
                                        L.isMatch ? (T[A] = L.score,
                                        g = !0,
                                        O = !0,
                                        I.push(L.score)) : (T[A] = 1,
                                ...
                                for (var x = I.length, k = 1; k < x; k += 1)
                                    _ += I[k];
                                _ /= x,
                                this._log("Token score average:", _)
                            }
                            var P = y.score;
                            _ > -1 && (P = (P + _) / 2),
                ...
                value: function(e, t) {
                    ...
                    for (var i = 0, n = t.length; i < n; i += 1) {
                        for (var s = t[i].output, r = s.length, o = 1, a = 1, c = 0; c < r; c += 1) {
                            ...
                            1 !== l ? a = Math.min(a, h) : (s[c].nScore = h,
                            o *= h)
                        }
                        t[i].score = 1 === a ? o : a,
                        this._log(t[i])
    ...
    , function(e, t) {
        e.exports = function() {
            for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, i = [], n = -1, s = -1, r = 0, o = e.length; r < o; r += 1) {
                var a = e[r];
                a && -1 === n ? n = r : a || -1 === n || ((s = r - 1) - n + 1 >= t && i.push([n, s]),
                n = -1)
            }
    ...
    function(e) {
        ...
        items: function(e, t) {
            ...
            case "HIGHLIGHT_ITEM":
                return e.map((function(e) {
                    var i = e;
                    return i.id === t.id && (i.highlighted = t.highlighted),
                    i
                }
                ));
            default:
        ...
        choices: function(e, t) {
            ...
            case "ADD_ITEM":
                return t.activateOptions ? e.map((function(e) {
                    var i = e;
                    return i.active = t.active,
                    i
                }
                )) : t.choiceId > -1 ? e.map((function(e) {
                    var i = e;
                    return i.id === parseInt(t.choiceId, 10) && (i.selected = !0),
                    i
                }
                )) : e;
            case "REMOVE_ITEM":
                return t.choiceId > -1 ? e.map((function(e) {
                    var i = e;
                    return i.id === parseInt(t.choiceId, 10) && (i.selected = !1),
                    i
                }
                )) : e;
            case "FILTER_CHOICES":
      ...
      , pe = function() {
        ...
        t._animateScroll = function(e, t) {
            var i = this
              ...
              , s = !1;
            t > 0 ? (this._scrollDown(n, 4, e),
            n < e && (s = !0)) : (this._scrollUp(n, 4, e),
            n > e && (s = !0)),
    ...
    var be = function(e) {
      ...
      , ye = {
        containerOuter: function(e, t, i, n, s, r) {
            ...
            t && (a.dir = t),
            n && (a.tabIndex = 0),
            i && (a.setAttribute("role", s ? "combobox" : "listbox"),
        ...
        choice: function(e, t, i) {
            ...
            g.setAttribute("aria-disabled", "true")) : (g.classList.add(r),
        ...
        notice: function(e, t, i) {
            ...
            void 0 === i && (i = "");
            var a = [n, s];
            return "no-choices" === i ? a.push(o) : "no-results" === i && a.push(r),
        ...
        option: function(e) {
            ...
            return n && (o.dataset.customProperties = n),
            o.disabled = r,
            o
        }
    }
    ...
    var Ce = "-ms-scroll-limit"in document.documentElement.style && "-ms-ime-align"in document.documentElement.style
      ...
      , Le = function() {
        ...
        function n(e, t) {
            ...
            if (this._isTextElement = r.type === ae,
        ...
        r.highlightItem = function(e, t) {
            ...
            return this._store.dispatch(Ie(i, !0)),
            t && this.passedElement.triggerEvent(V, {
                id: i,
                value: o,
                label: c,
        ...
        r.unhighlightItem = function(e) {
            ...
            return this._store.dispatch(Ie(t, !1)),
        ...
        r.setChoices = function(e, t, i, n) {
            ...
            "function" == typeof e) {
                ...
                if (!Array.isArray(r))
                    throw new TypeError(".setChoices first argument function must return either array of choices or Promise, got: " + typeof r);
        ...
        r._renderChoices = function() {
            ...
            if (s.childNodes && s.childNodes.length > 0) {
                ...
                a.response ? (this.choiceList.append(s),
                this._highlightChoice()) : this.choiceList.append(this._getTemplate("notice", a.notice))
            } else {
                var c, l;
                this._isSearching ? (l = "function" == typeof this.config.noResultsText ? this.config.noResultsText() : this.config.noResultsText,
                c = this._getTemplate("notice", l, "no-results")) : (l = "function" == typeof this.config.noChoicesText ? this.config.noChoicesText() : this.config.noChoicesText,
        ...
        r._handleLoadingState = function(e) {
            ...
            this.itemList.append(t)) : this.input.placeholder = this.config.loadingText) : (this.enable(),
        ...
        r._onKeyDown = function(e) {
            var t, i = e.target, n = e.keyCode, s = e.ctrlKey, r = e.metaKey, o = this._store.activeItems, a = this.input.isFocussed, c = this.dropdown.isActive, l = this.itemList.hasChildren(), h = String.fromCharCode(n), u = Z, d = Q, p = ee, m = te, f = ie, v = ne, g = se, _ = re, b = oe, y = s || r;
            !this._isTextElement && /[a-zA-Z0-9-_ ]/.test(h) && this.showDropdown();
            var E = ((t = {})[m] = this._onAKey,
        ...
        r._onKeyUp = function(e) {
            ...
            if (this._isTextElement) {
                ...
                l && h ? (this._isSearching = !1,
                this._store.dispatch(Ee(!0))) : u && this._handleSearch(this.input.value)
            }
            this._canSearch = this.config.searchEnabled
        }
        ,
        r._onAKey = function(e) {
            var t = e.hasItems;
            e.hasCtrlDownKeyPressed && t && (this._canSearch = !1,
        ...
        r._onEnterKey = function(e) {
            ...
            if (this._isTextElement && i.value) {
                ...
                this._canAddItem(n, a).response && (this.hideDropdown(!0),
                this._addItem({
                    value: a
                }),
            ...
            if (o && (this._handleButtonAction(n, i),
            t.preventDefault()),
            s) {
        ...
        r._onEscapeKey = function(e) {
            e.hasActiveDropdown && (this.hideDropdown(!0),
            this.containerOuter.focus())
        }
        ,
        r._onDirectionKey = function(e) {
            ...
            if (r || this._isSelectOneElement) {
                ...
                var u, d = o === c || o === h ? 1 : -1;
                if (a || o === h || o === l)
                    u = d > 0 ? this.dropdown.element.querySelector("[data-choice-selectable]:last-of-type") : this.dropdown.element.querySelector("[data-choice-selectable]");
                else {
        ...
        r._onDeleteKey = function(e) {
            var t = e.event
              ...
              , n = e.hasFocusedInput
              , s = e.activeItems;
            !n || i.value || this._isSelectOneElement || (this._handleBackspace(s),
            t.preventDefault())
        }
        ,
        ...
        r._onBlur = function(e) {
            ...
            if (this.containerOuter.element.contains(i) && !this._isScrollingOnIe) {
                ...
                ((n = {})[ae] = function() {
                    i === t.input.element && (t.containerOuter.removeFocusState(),
                    s && t.unhighlightAll(),
                    t.hideDropdown(!0))
                }
                ,
        ...
        r._highlightChoice = function(e) {
            ...
            if (i.length) {
                ...
                this.passedElement.triggerEvent(G, {
                    el: n
                }),
        ...
        r._addItem = function(e) {
            var t = e.value
              ...
              , E = g ? g.length + 1 : 1;
            return this.config.prependValue && (m = this.config.prependValue + m.toString()),
        ...
        r._removeItem = function(e) {
            ...
            o && o.value ? this.passedElement.triggerEvent(B, {
                id: t,
                value: i,
                label: n,
                groupValue: o.value
